...
void TauSelector::Fill(const edm::Event& iEvent, const edm::EventSetup& iSetup){
  ...
  for(edm::View<pat::Tau>::const_iterator tau = taus->begin(); tau != taus->end(); tau++){
   ...
   // Tau_byVTightIsolationMVArun2v1DBnewDMwLT.push_back(tau->tauID("byVTightIsolationMVArun2v1DBnewDMwLT"));
    ...
    Tau_byDeepTau2017v2p1VSjetraw.push_back(tau->tauID("byDeepTau2017v2p1VSjetraw"));
    Tau_byVVVLooseDeepTau2017v2p1VSjet.push_back(tau->tauID("byVVVLooseDeepTau2017v2p1VSjet"));
    Tau_byVVLooseDeepTau2017v2p1VSjet.push_back(tau->tauID("byVVLooseDeepTau2017v2p1VSjet"));
    Tau_byVLooseDeepTau2017v2p1VSjet.push_back(tau->tauID("byVLooseDeepTau2017v2p1VSjet"));
    ...
    Tau_byVTightDeepTau2017v2p1VSjet.push_back(tau->tauID("byVTightDeepTau2017v2p1VSjet"));
    Tau_byVVTightDeepTau2017v2p1VSjet.push_back(tau->tauID("byVVTightDeepTau2017v2p1VSjet"));
    Tau_byDeepTau2017v2p1VSmuraw.push_back(tau->tauID("byDeepTau2017v2p1VSmuraw"));
    Tau_byVLooseDeepTau2017v2p1VSmu.push_back(tau->tauID("byVLooseDeepTau2017v2p1VSmu"));
    ...
    Tau_byDeepTau2017v2p1VSeraw.push_back(tau->tauID("byDeepTau2017v2p1VSeraw"));
    Tau_byVVVLooseDeepTau2017v2p1VSe.push_back(tau->tauID("byVVVLooseDeepTau2017v2p1VSe"));
    Tau_byVVLooseDeepTau2017v2p1VSe.push_back(tau->tauID("byVVLooseDeepTau2017v2p1VSe"));
    Tau_byVLooseDeepTau2017v2p1VSe.push_back(tau->tauID("byVLooseDeepTau2017v2p1VSe"));
    ...
    Tau_byVTightDeepTau2017v2p1VSe.push_back(tau->tauID("byVTightDeepTau2017v2p1VSe"));
    Tau_byVVTightDeepTau2017v2p1VSe.push_back(tau->tauID("byVVTightDeepTau2017v2p1VSe"));
...
void TauSelector::SetBranches(){
  ...
  AddBranch(&Tau_byDeepTau2017v2p1VSjetraw           ,"Tau_byDeepTau2017v2p1VSjetraw");
  AddBranch(&Tau_byVVVLooseDeepTau2017v2p1VSjet           ,"Tau_byVVVLooseDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byVVLooseDeepTau2017v2p1VSjet           ,"Tau_byVVLooseDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byVLooseDeepTau2017v2p1VSjet           ,"Tau_byVLooseDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byLooseDeepTau2017v2p1VSjet           ,"Tau_byLooseDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byMediumDeepTau2017v2p1VSjet          ,"Tau_byMediumDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byTightDeepTau2017v2p1VSjet           ,"Tau_byTightDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byVTightDeepTau2017v2p1VSjet          ,"Tau_byVTightDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byVVTightDeepTau2017v2p1VSjet          ,"Tau_byVVTightDeepTau2017v2p1VSjet");
  AddBranch(&Tau_byDeepTau2017v2p1VSmuraw           ,"Tau_byDeepTau2017v2p1VSmuraw");
  AddBranch(&Tau_byVLooseDeepTau2017v2p1VSmu           ,"Tau_byVLooseDeepTau2017v2p1VSmu");
  AddBranch(&Tau_byLooseDeepTau2017v2p1VSmu           ,"Tau_byLooseDeepTau2017v2p1VSmu");
  AddBranch(&Tau_byMediumDeepTau2017v2p1VSmu          ,"Tau_byMediumDeepTau2017v2p1VSmu");
  AddBranch(&Tau_byTightDeepTau2017v2p1VSmu           ,"Tau_byTightDeepTau2017v2p1VSmu");
  AddBranch(&Tau_byDeepTau2017v2p1VSeraw           ,"Tau_byDeepTau2017v2p1VSeraw");
  AddBranch(&Tau_byVVVLooseDeepTau2017v2p1VSe           ,"Tau_byVVVLooseDeepTau2017v2p1VSe");
  AddBranch(&Tau_byVVLooseDeepTau2017v2p1VSe           ,"Tau_byVVLooseDeepTau2017v2p1VSe");
  AddBranch(&Tau_byVLooseDeepTau2017v2p1VSe           ,"Tau_byVLooseDeepTau2017v2p1VSe");
  AddBranch(&Tau_byLooseDeepTau2017v2p1VSe           ,"Tau_byLooseDeepTau2017v2p1VSe");
  AddBranch(&Tau_byMediumDeepTau2017v2p1VSe          ,"Tau_byMediumDeepTau2017v2p1VSe");
  AddBranch(&Tau_byTightDeepTau2017v2p1VSe           ,"Tau_byTightDeepTau2017v2p1VSe");
  AddBranch(&Tau_byVTightDeepTau2017v2p1VSe          ,"Tau_byVTightDeepTau2017v2p1VSe");
  AddBranch(&Tau_byVVTightDeepTau2017v2p1VSe          ,"Tau_byVVTightDeepTau2017v2p1VSe");
  //Other prop and Track related variables
...
void TauSelector::Clear(){/*{{{*/
  ...
  Tau_byDeepTau2017v2p1VSjetraw.clear();
  Tau_byVVVLooseDeepTau2017v2p1VSjet.clear();
  Tau_byVVLooseDeepTau2017v2p1VSjet.clear();
  Tau_byVLooseDeepTau2017v2p1VSjet.clear();
  Tau_byLooseDeepTau2017v2p1VSjet.clear();
  Tau_byMediumDeepTau2017v2p1VSjet.clear();
  Tau_byTightDeepTau2017v2p1VSjet.clear();
  Tau_byVTightDeepTau2017v2p1VSjet.clear();
  Tau_byVVTightDeepTau2017v2p1VSjet.clear();
  Tau_byDeepTau2017v2p1VSmuraw.clear();
  Tau_byVLooseDeepTau2017v2p1VSmu.clear();
  Tau_byLooseDeepTau2017v2p1VSmu.clear();
  Tau_byMediumDeepTau2017v2p1VSmu.clear();
  Tau_byTightDeepTau2017v2p1VSmu.clear();
  Tau_byDeepTau2017v2p1VSeraw.clear();
  Tau_byVVVLooseDeepTau2017v2p1VSe.clear();
  Tau_byVVLooseDeepTau2017v2p1VSe.clear();
  Tau_byVLooseDeepTau2017v2p1VSe.clear();
  Tau_byLooseDeepTau2017v2p1VSe.clear();
  Tau_byMediumDeepTau2017v2p1VSe.clear();
  Tau_byTightDeepTau2017v2p1VSe.clear();
  Tau_byVTightDeepTau2017v2p1VSe.clear();
  Tau_byVVTightDeepTau2017v2p1VSe.clear();
  //Other prop and Track related variables
  Tau_nProngs.clear();
